...
# cbmi + md -> bc
mvmr_cBMIs_md_to_bc <- read_tsv(paste0(results_path, current_trait_category, "/mvmr/merged/merged_mvmr_earlyBMI-",current_trait_category,"-to-BCAC.tsv")) 
mvmr_cBMIs_md_to_bc_sens <- read_tsv(paste0(results_path, current_trait_category, "/mvmr/merged/merged_sens_mvmr_sens_earlyBMI-",current_trait_category,"-to-BCAC.tsv"))
...
sheets <- list("1bmi_to_md" = bmi_to_md, 
               ...
               "11mvmr_cBMIs_md_to_bc"= mvmr_cBMIs_md_to_bc,
               "12mvmr_cBMIs_md_to_bc_sens" = mvmr_cBMIs_md_to_bc_sens
               ) 
