...
sheets <- list("Guide" = guide_table,
               "S3 bmi_to_md" = bmi_to_md, 
               "S4 bmi_to_md_sens" = bmi_to_md_sens,
               "S5 mvmr_BMIs_to_md"=mvmr_BMIs_to_md, 
               "S6 mvmr_BMIs_to_md_sens"=mvmr_BMIs_to_md_sens, 
               "S7 aam_to_md" = aam_to_md, # cmi total is in 1
               "S8 aam_to_md_sens" = aam_to_md_sens,
               "S9 mvmr_aaM_cbmi_to_md" = mvmr_aaM_cbmi_to_md,
               "S10 mvmr_aaM_cbmi_to_md_sens" = mvmr_aaM_cbmi_to_md_sens,
               "S11 md_to_bc" = md_to_bc,
               "S12 md_to_bc_sens" = md_to_bc_sens,
               "S13 mvmr_cBMI_md_to_bc"= mvmr_cBMI_md_to_bc,
               "S14 mvmr_cBMI_md_to_bc_sens" = mvmr_cBMI_md_to_bc_sens,
               "S15 mrpresso" = mrpresso
               ) 
