...
for (i in 1:9 ){ 
  ...
  forest_radial <- mr_forest_plot_outliers(res_outliers_radial,  outliers_list=outliers_list, outliers_colour = "orange", method = "Radial-MR", snp_order = rev(SNPorder) )
...
write_tsv(radial_results, paste0(results_path, dir, "/presso_radial/", exp_code,"_radial_supl_subtypesBC.tsv"))
...
ggsave(plot=radial_plots, 
      height=12, width=12, scale=1.5, dpi=300, 
      filename=paste0(results_path, dir, "/presso_radial/subtypes_", exp_code,"_snps_outliers_forest_radial_ALL_ordered.png"))
