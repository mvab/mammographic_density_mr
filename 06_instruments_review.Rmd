...
phewas_plot <- ggplot(data = snp_phewas_df3, mapping = aes(x = rsid, y = log10P_trunc, colour=cluster, shape= label, size=label)) + 
  ...
  labs(subtitle="PheWAS results", colour= "Cluster", shape  = "Association with",
