...
```{r}
da_new <- read_tsv(paste0(data_path_tophits, "dense_area_tophits.tsv")) %>% 
         filter(!SNP %in% c(#"rs10995181","rs3821098", "rs75197674",
                            "rs11205303", "rs11684853","rs17625845",
                            "rs6001984"
                            #"rs492602"
...
for (i in 1:10){
  set.seed(i)
  instruments2 <-  sample_n(adul_bmi_inst, 30) # pick 30 at random from list of 79
